---
title: "1. Discretized Non-negative Matrix Factorization Algorithms (`dNMF`)"
author:
- name: Koki Tsuyuzaki
...
vignette: |
  %\VignetteIndexEntry{1. Discretized Non-negative Matrix Factorization Algorithms (`dNMF`)}
...
This is known as binary matrix factorization (BMF). @bmf et al. developed BMF by binary regularization against non-negative matrix factorization (NMF [@nmf; @amari]).
...
```{r data4, echo=TRUE, fig.height=4, fig.width=4}
